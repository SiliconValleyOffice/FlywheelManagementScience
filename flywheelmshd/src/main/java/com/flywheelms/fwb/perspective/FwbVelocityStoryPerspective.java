/* @(#)FwbVelocityStoryPerspective.java
** 
...
public class FwbVelocityStoryPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.STORY;
	}

	public FwbVelocityStoryPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.velocity__story;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__VELOCITY__STORY;
	}
