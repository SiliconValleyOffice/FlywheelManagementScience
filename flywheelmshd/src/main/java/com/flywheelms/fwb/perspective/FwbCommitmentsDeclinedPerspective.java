/* @(#)FwbCommitmentsDeclinedPerspective.java
** 
...
package com.flywheelms.fwb.perspective;
...
public class FwbCommitmentsDeclinedPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.DECLINED_COMMITMENTS;
	}

	public FwbCommitmentsDeclinedPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.commitments__proposed_and_declined;
	}

	@Override
	protected int getAbreviatedPageTitleResourceId() {
		return R.string.completion_commitment_type__declined;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__DECLINED_COMMITMENTS;
	}
