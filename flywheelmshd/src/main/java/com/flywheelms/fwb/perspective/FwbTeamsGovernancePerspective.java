/* @(#)FwbTeamsGovernancePerspective.java
** 
...
public class FwbTeamsGovernancePerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.GOVERNANCE_TEAMS;
	}

	public FwbTeamsGovernancePerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.teams__governance;
	}
	
	@Override
	protected int getAbreviatedPageTitleResourceId() {
		return R.string.teams__governance__abreviated;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__TEAMS__GOVERNANCE;
	}
