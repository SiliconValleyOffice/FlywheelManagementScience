/* @(#)FwbCommitmentsWithdrawnPerspective.java
** 
...
public class FwbCommitmentsWithdrawnPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.WITHDRAWN_COMMITMENTS;
	}

	public FwbCommitmentsWithdrawnPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getAbreviatedPageTitleResourceId() {
		return R.string.completion_commitment_type__withdrawn;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__WITHDRAWN_COMMITMENTS;
	}
