/* @(#)FwbTeamsStrategyPerspective.java
** 
...
public class FwbTeamsStrategyPerspective extends FmsPerspectiveFlipperTreeView {
	...
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.STRATEGY_TEAMS;
	}

	public FwbTeamsStrategyPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.teams__strategic;
	}
	
	@Override
	protected int getAbreviatedPageTitleResourceId() {
		return R.string.teams__strategic__abreviated;
	}
