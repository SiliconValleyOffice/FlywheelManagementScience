/* @(#)FwbQualityServiceDeliveryPerspective.java
** 
...
public class FwbQualityServiceDeliveryPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.SERVICE_DELIVERY;
	}

	public FwbQualityServiceDeliveryPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.tribkn_quality__service_delivery;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__QUALITY__SERVICE_DELIVERY;
	}
