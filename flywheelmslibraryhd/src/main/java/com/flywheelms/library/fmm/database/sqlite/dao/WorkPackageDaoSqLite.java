...
public class WorkPackageDaoSqLite extends CompletableNodeDaoSqLite<WorkPackage> {
	...
	protected void buildColumnIndexMap(Cursor aCursor) {
		...
		putColumnIndexMapEntry(this.columnIndexMap, aCursor, WorkPackageMetaData.column_PROJECT_ASSET_ID);
	...
	protected void getColumnValues(HashMap<String, Integer> aHashMap, Cursor aCursor, WorkPackage aWorkPackage) {
		...
		aWorkPackage.setProjectAssetNodeIdString(aCursor.getString(aHashMap.get(WorkPackageMetaData.column_PROJECT_ASSET_ID)));
	...
	public ContentValues buildContentValues(WorkPackage aWorkPackage) {
		...
		theContentValues.put(WorkPackageMetaData.column_PROJECT_ASSET_ID, aWorkPackage.getProjectAssetNodeIdString());
