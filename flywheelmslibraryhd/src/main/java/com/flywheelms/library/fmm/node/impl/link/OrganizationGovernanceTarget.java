/* @(#)OrganizationLinkGovernanceTarget.java
** 
...
public class OrganizationGovernanceTarget extends FmmLinkNodeImpl {

	public OrganizationGovernanceTarget(
