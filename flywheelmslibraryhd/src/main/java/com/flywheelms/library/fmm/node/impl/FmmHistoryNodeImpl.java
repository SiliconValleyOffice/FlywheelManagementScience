...
public class FmmHistoryNodeImpl extends FmmAuditNodeImpl implements GcgHistory {
	...
	public FmmHistoryNodeImpl(NodeId aNodeId) {
		super(aNodeId);
	}
	
	public FmmHistoryNodeImpl(Class<? extends FmmHistoryNodeImpl> aClass, JSONObject aJsonObject) {
		super(aClass, aJsonObject);
	}

	@Override
	public String getSerializedBaseline() {
		if(this.serializedBaseline == null) {
			this.serializedBaseline = getSerialized();
		}
		return this.serializedBaseline;
	}

	@Override
	public String updateSerializedBaseline() {
		return this.serializedBaseline = getSerialized();
	}
	
	@Override
	public ArrayList<HistoryEventData> getHistoryEventDataList() {
		ArrayList<HistoryEventData> theEventDataList = new ArrayList<HistoryEventData>();
		// there are no data members of interest at this level of the class hierarchy
		return theEventDataList;
	}
