...
public class CommunityMemberMetaData extends HeadlineNodeMetaData {
	
	public static final String column_COMMUNITY_MEMBER_STATUS = "community_member_status";
	public static final String column_AGGREGATE_TEAM_ALLOCATION = "aggregate_team_allocation";
