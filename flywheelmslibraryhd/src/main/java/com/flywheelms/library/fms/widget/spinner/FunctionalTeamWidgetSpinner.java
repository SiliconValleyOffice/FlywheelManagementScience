/* @(#)FunctionalTeamWidgetSpinner.java
** 
...
public class FunctionalTeamWidgetSpinner extends FmmHeadlineNodeWidgetSpinner {

	public FunctionalTeamWidgetSpinner(Context aContext, AttributeSet anAttributeSet) {
