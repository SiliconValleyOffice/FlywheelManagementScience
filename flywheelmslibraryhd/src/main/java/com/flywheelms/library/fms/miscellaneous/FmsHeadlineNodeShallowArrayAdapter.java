...
public class FmsHeadlineNodeShallowArrayAdapter extends ArrayAdapter<FmmHeadlineNodeShallow> {
	...
	private ArrayList<FmmHeadlineNodeShallow> headlineNodeShallowList;

	public FmsHeadlineNodeShallowArrayAdapter(Context aContext, ArrayList<FmmHeadlineNodeShallow> aHeadlineNodeShallowList) {
		super(aContext, ROW_LAYOUT_RESOURCE_ID, aHeadlineNodeShallowList);
		this.context = aContext;
		this.headlineNodeShallowList = aHeadlineNodeShallowList;
	}
	...
	public View getView(int aListPosition, View anExistingRowView, ViewGroup aViewGroupParent) {
		...
		FmmHeadlineNodeShallow theListItem = this.headlineNodeShallowList.get(aListPosition);
