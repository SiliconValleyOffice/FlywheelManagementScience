...
public class ProjectAssetOrphanDialog extends HeadlineNodeOrphanDialog {
	...
	private final StrategicMilestone strategicMilestone;
	...
	protected boolean orphanHeadlineNode() {
		return FmmDatabaseMediator.getActiveMediator().orphanProjectAssetFromStrategicMilestone(this.headlineNode.getNodeIdString(), this.strategicMilestone.getNodeIdString(), true);
	}
