...
public class FmmAccessScopeTextView extends GcgWidgetTextView {
	...
	public FmmAccessScopeTextView(Context aContext, AttributeSet anAttributeSet) {
		super(aContext, anAttributeSet);
	}

	@Override
	protected String getLabelText() {
		return this.labelTextString == null ? "Access Scope" : this.labelTextString;
	}

	public FmmAccessScope getFmmAccessScope() {
		return FmmAccessScope.getObjectForName(this.textView.getText().toString());
	}
