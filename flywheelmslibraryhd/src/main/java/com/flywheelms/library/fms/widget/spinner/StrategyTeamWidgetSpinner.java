/* @(#)StrategyTeamWidgetSpinner.java
** 
...
public class StrategyTeamWidgetSpinner extends FmmHeadlineNodeWidgetSpinner {

	public StrategyTeamWidgetSpinner(Context aContext, AttributeSet anAttributeSet) {
