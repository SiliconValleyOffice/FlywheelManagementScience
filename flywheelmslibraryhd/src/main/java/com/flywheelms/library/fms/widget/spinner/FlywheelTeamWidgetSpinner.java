/* @(#)FlywheelTeamWidgetSpinner.java
** 
...
public class FlywheelTeamWidgetSpinner extends FmmHeadlineNodeWidgetSpinner {

	public FlywheelTeamWidgetSpinner(Context aContext, AttributeSet anAttributeSet) {
		super(aContext, anAttributeSet);
	}

	@Override
	protected String getLabelText() {
		return "Flywheel Team";
	}
