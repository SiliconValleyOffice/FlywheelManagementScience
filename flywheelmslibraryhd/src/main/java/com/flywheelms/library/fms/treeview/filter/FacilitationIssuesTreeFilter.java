/* @(#)FacilitationIssuesTreeFilter.java
** 
...
public class FacilitationIssuesTreeFilter extends GcgTreeFilter {

	public FacilitationIssuesTreeFilter(View aTreeView) {
		super(aTreeView);
	}

	private static final long serialVersionUID = -4592693451024929827L;
