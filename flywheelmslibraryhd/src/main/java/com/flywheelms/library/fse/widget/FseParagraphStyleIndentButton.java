/* @(#)FseParagraphStyleIndentButton.java
** 
...
public class FseParagraphStyleIndentButton extends GcgMultiShiftClientButton {
...
//		FseParagraphStyleIndentButton.supportedStateHashTable.put(GcgMultiShiftState.ALT_SHIFT, R.drawable.fse__style_indent__green);
	...
	public FseParagraphStyleIndentButton(
			Context aContext,
	...
	public HashMap<GcgMultiShiftState, Integer> getSupportedStateHashTable() {
		return FseParagraphStyleIndentButton.supportedStateHashTable;
	}
