/* @(#)FseDocumentSectionStoryPerspective.java
** 
...
public class FseDocumentSectionStoryPerspective extends FseDocumentSectionParagraphEditorPerspective {
	...
	private GcgPerspective gcgPerspective = FmmPerspective.STORY;
	...
	public FseDocumentSectionStoryPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	protected int getPageTitleResourceId() {
		return R.string.fse__document_section__story;
	}

	@Override
	protected int getViewLayoutResourceId() {
		return R.layout.fms_view__document_section__story;
	}
	
	@Override
	public String getHelpContextUrlString() {
		return FmsHelpIndex.FSE__DOCUMENT_SECTION__STORY;
	}

	public FseDocumentSectionStory getDocumentSectionClone() {
		this.paragraphEditor.updateInitialFocus();
		FseDocumentSectionStory theDocumentSectionStory = new FseDocumentSectionStory();
		copyToDocumentSectionParagraphEditorContent(this, theDocumentSectionStory);
		return new FseDocumentSectionStory(theDocumentSectionStory.getJsonObject());
	}
