/* @(#)FseParagraphContentDrawingPadView.java
** 
...
@SuppressLint("ViewConstructor")  // only instantiated at run time
public class FseParagraphContentDrawingPadView extends View implements FseParagraphContentView{
	
	FseParagraphView paragraphView;
	
	public FseParagraphContentDrawingPadView(FseParagraphView anFseParagraph) {
		super(anFseParagraph.getParagraphEditor().getContext());
	...
	public FsePerspectiveFlipper getDocumentView() {
		return getParagraphView().getParagraphEditor().getDocumentView();
	}
