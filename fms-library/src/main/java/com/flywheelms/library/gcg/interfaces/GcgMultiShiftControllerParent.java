/* @(#)GcgMultiShiftControllerParent.java
** 
...
public interface GcgMultiShiftControllerParent {
	
	boolean isMultipleSelections();

	ArrayList<GcgMultiShiftState> getSupportedMultiShiftStateList();

	ArrayList<? extends GcgMultiShiftButton> getShiftButtonList();
