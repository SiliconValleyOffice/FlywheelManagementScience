...
public class TeamsTreeFilter extends GcgTreeFilter {

	public TeamsTreeFilter(View aTreeView) {
		super(aTreeView);
	}

	private static final long serialVersionUID = -6181497307949839405L;
