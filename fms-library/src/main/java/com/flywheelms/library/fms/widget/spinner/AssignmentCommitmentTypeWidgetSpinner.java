...
public class AssignmentCommitmentTypeWidgetSpinner extends GcgWidgetSpinner {

	public AssignmentCommitmentTypeWidgetSpinner(Context aContext, AttributeSet anAttributeSet) {
		super(aContext, anAttributeSet);
	}

	@Override
	protected String getLabelText() {
		return this.labelTextString == null ? AssignmentCommitmentType.getStaticInstance().getLabelText() : this.labelTextString;
	}
	...
	protected ArrayList<GcgGuiable> updateGuiableList() {
		return new ArrayList<GcgGuiable>(Arrays.asList(AssignmentCommitmentType.values()));
	}

	public void setAssignmentCommitmentType(AssignmentCommitmentType anAssignmentCommitmentType) {
		setSelection(anAssignmentCommitmentType);
	}
