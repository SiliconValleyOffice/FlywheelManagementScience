/* @(#)ServiceDeliveryTreeFilter.java
** 
...
public class ServiceDeliveryTreeFilter extends GcgTreeFilter {

	public ServiceDeliveryTreeFilter(View aTreeView) {
		super(aTreeView);
	}

	private static final long serialVersionUID = -5451141362094481936L;
