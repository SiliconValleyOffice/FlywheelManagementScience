...
public class CommitmentsTreeFilter extends GcgTreeFilter {

	public CommitmentsTreeFilter(View aTreeView) {
		super(aTreeView);
	}

	private static final long serialVersionUID = -5829478659742702039L;
