...
public class FmsAnalysisPerspective extends FmsPerspectiveFlipperView {
	...
	public FmsAnalysisPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	@Override
	protected int getPageTitleResourceId() {
		return R.string.tree_node__analysis;
	}
	
	@Override
	protected int getViewLayoutResourceId() {
		return R.layout.fms_view__analysis;
	}

	@Override
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__ANALYSIS;
	}
