...
public class StrategicAssetDeleteDialog extends HeadlineNodeDeleteDialog {

	public StrategicAssetDeleteDialog(GcgActivity aLibraryActivity, FmsTreeViewAdapter aTreeViewAdapter, FmmHeadlineNode aHeadlineNode) {
	...
	protected boolean deleteHeadlineNode() {
		return FmmDatabaseMediator.getActiveMediator().deleteStrategicAsset((StrategicAsset) getFmmHeadlineNode(), false);
	}
