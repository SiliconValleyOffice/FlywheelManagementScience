...
public class WorkPlanningTreeFilter extends GcgTreeFilter {

	public WorkPlanningTreeFilter(View aTreeView) {
		super(aTreeView);
	}

	private static final long serialVersionUID = 7264006549580040312L;
