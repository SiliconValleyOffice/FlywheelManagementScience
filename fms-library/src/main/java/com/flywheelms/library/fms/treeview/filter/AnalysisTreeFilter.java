...
public class AnalysisTreeFilter extends GcgTreeFilter {

	public AnalysisTreeFilter(View aTreeView) {
		super(aTreeView);
	}

	private static final long serialVersionUID = 282808609011597697L;
