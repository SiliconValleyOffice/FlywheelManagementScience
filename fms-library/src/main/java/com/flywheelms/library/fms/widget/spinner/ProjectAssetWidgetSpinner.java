...
public class ProjectAssetWidgetSpinner extends FmmHeadlineNodeWidgetSpinner {
	...
	protected ArrayList<GcgGuiable> getPrimaryParentPrimaryChildMoveTargetGuiableList() {
		...
		if(this.project == null) {
			...
			theGuiableList = new ArrayList<GcgGuiable>(FmmDatabaseService.getActiveMediator().retrieveProjectAssetList(
    ...
    protected ArrayList<GcgGuiable> getPrimaryParentPrimaryChildPrimaryChildMoveTargetGuiableList() {
        ...
        if(this.project == null) {
            ...
            theGuiableList = new ArrayList<GcgGuiable>(FmmDatabaseService.getActiveMediator().retrieveProjectAssetListForWorkTaskMoveTarget(
