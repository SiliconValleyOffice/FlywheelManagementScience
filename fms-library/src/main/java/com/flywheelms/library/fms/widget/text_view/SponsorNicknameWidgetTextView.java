/* @(#)SponsorNicknameWidgetTextView.java
** 
...
public class SponsorNicknameWidgetTextView extends GcgWidgetTextView {
	...
	public SponsorNicknameWidgetTextView(Context aContext, AttributeSet anAttributeSet) {
		super(aContext, anAttributeSet);
	}

	@Override
	protected String getLabelText() {
		return GovernanceRole.SPONSOR.getName();
	}
