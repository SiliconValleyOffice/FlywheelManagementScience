...
public class WorkAssetEditorActivity extends FmmNodeEditorActivity {

	public WorkAssetEditorActivity() {
		super(FmmNodeDefinition.WORK_ASSET, FmsHelpIndex.WORK_ASSET_ACTIVITY);
	}
	...
	public void saveAllDataModifications() {
		...
		FmsActivity.getActiveDatabaseMediator().updateProjectAsset((ProjectAsset) getDisplayedFmmHeadlineNode(), true);
	}
