...
public class ProjectAssetDeleteDialog extends HeadlineNodeDeleteDialog {
	...
	public ProjectAssetDeleteDialog(GcgActivity aLibraryActivity, FmsTreeViewAdapter aTreeViewAdapter, FmmHeadlineNode aHeadlineNode) {
	...
	protected ArrayList<? extends FmmHeadlineNode> getPrimaryChildHeadlineNodeList() {
		return FmsActivity.getActiveDatabaseMediator().retrieveWorkPackageList(getProjectAsset());
	}
	...
	protected boolean deleteHeadlineNode() {
		return FmsActivity.getActiveDatabaseMediator().deleteProjectAsset((ProjectAsset) getFmmHeadlineNode(), false);
	}
