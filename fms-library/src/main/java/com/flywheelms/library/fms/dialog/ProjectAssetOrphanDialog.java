...
public class ProjectAssetOrphanDialog extends HeadlineNodeOrphanDialog {
	...
	protected boolean orphanHeadlineNode() {
		return this.parentNode.getFmmNodeDefinition() == FmmNodeDefinition.PROJECT ?
            FmsActivity.getActiveDatabaseMediator().orphanSingleProjectAssetFromProject(getFmmHeadlineNode().getNodeIdString(), this.parentNode.getNodeIdString(), true) :
            FmsActivity.getActiveDatabaseMediator().orphanSingleProjectAssetFromStrategicMilestone(getFmmHeadlineNode().getNodeIdString(), this.parentNode.getNodeIdString(), true);
    }
