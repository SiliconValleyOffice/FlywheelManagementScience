...
public class CustomerNicknameWidgetTextView extends GcgWidgetTextView {
	
	public CustomerNicknameWidgetTextView(Context aContext, AttributeSet anAttributeSet) {
