...
import com.flywheelms.library.gcg.dialog.GcgCancelOkFdkDialog;

public abstract class FmsCancelOkFdkDialog extends GcgCancelOkFdkDialog {

    protected FmsDialogExtension fmsDialogExtension = new FmsDialogExtension();

    public FmsCancelOkFdkDialog(GcgActivity aGcgActivity) {
        this(aGcgActivity, "", "", null, null, null);
    }

    public FmsCancelOkFdkDialog(GcgActivity aGcgActivity, FmmHeadlineNode aHeadlineNode) {
        this(aGcgActivity, "", "", aHeadlineNode.getFmmNodeDefinition(), aHeadlineNode, null);
    }

    public FmsCancelOkFdkDialog(GcgActivity aGcgActivity, FmmNodeDefinition anFmmNodeDefinition) {
        this(aGcgActivity, "", "", anFmmNodeDefinition, null, null);
    }

    public FmsCancelOkFdkDialog(GcgActivity aGcgActivity, String aTargetDetail) {
        this(aGcgActivity, aTargetDetail, "", null, null, null);
    }

    public FmsCancelOkFdkDialog(
