...
public enum CommunityMemberStatus implements FmmEnumNode {
	
	ACTIVE ("Active", R.string.community_member_status__active, R.string.community_member_status__active__description, R.drawable.fmm_noun__community_member__active),
	INACTIVE ("Inactive", R.string.community_member_status__inactive, R.string.community_member_status__inactive__description, R.drawable.fmm_noun__community_member__inactive),
	ON_VACATION ("OnVacation", R.string.community_member_status__on_vacation, R.string.community_member_status__on_vacation__description, R.drawable.fmm_noun__community_member__on_vacation),
	ON_LEAVE ("OnLeave", R.string.community_member_status__on_leave, R.string.community_member_status__on_leave__description, R.drawable.fmm_noun__community_member__on_leave);
	
	public static final String name_COLUMN_1 = "community_member_status";
	public static final String name_COLUMN_2 = "name";
	public static final String name_COLUMN_3 = "description";
	
	public static CommunityMemberStatus getObjectForName(String aName) {
		for(CommunityMemberStatus theCommunityMemberStatus : CommunityMemberStatus.values()) {
			if(theCommunityMemberStatus.getName().equals(aName)) {
				return theCommunityMemberStatus;
			}
		}
		return null;
	}
	
	public static CommunityMemberStatus getObjectForCode(String aCode) {
		for(CommunityMemberStatus theCommunityMemberStatus : CommunityMemberStatus.values()) {
			if(theCommunityMemberStatus.getCommunityMemberStatusCode().equals(aCode)) {
				return theCommunityMemberStatus;
			}
		}
		return null;
	...
	private static FmmNodeDefinition fmmNodeDictionaryEntry = FmmNodeDefinition.getEntryForClass(CommunityMemberStatus.class);
	...
	private String communityMemberStatusCode;
	...
	CommunityMemberStatus(String aCommunityMemberStatusCode, int aNameStringResourceId, int aDescriptionStringResourceId, int aDrawableResourceId) {
		...
		this.nodeId = new NodeId(
				FmmNodeDefinition.getEntryForClass(CommunityMemberStatus.class),
				getName() );
	}
