...
public interface FmmNodeAudit extends FmmNodeLocking {
	...
	CommunityMember getCreatedByCommunityMember();
	
	void setCreatedBy(CommunityMember aCommunityMember);
	...
	CommunityMember getLastUpdatedByCommunityMember();
	
	void setLastUpdatedBy(CommunityMember aCommunityMember);
