...
public class StrategicAsset extends FmmCompletableNodeImpl implements Comparable<StrategicAsset>, WorkAsset {
	...
	@Override
	public int compareTo(StrategicAsset anOtherProjectAsset) {
	...
	public JSONObject getJsonObject() {
		...
		try {
			...
			theJsonObject.put(StrategicAssetMetaData.column_PROJECT_ID, getProjectNodeIdString());
			theJsonObject.put(StrategicAssetMetaData.column_IS_STRATEGIC, isStrategic());
	...
	public static StrategicAsset getFmmConfiguration(Intent anIntent) {
		return FmmDatabaseMediator.getActiveMediator().retrieveStrategicAsset(NodeId.getNodeIdString(anIntent));
	}
