/* @(#)GovernanceParticipationType.java
** 
...
public enum GovernanceParticipationType implements FmmEnumNode {
	
	NONE (R.string.governance_participation_type__none, R.string.governance_participation_type__none__description, R.drawable.governance_participation_type__none),
	REQUIRED (R.string.governance_participation_type__required, R.string.governance_participation_type__required__description, R.drawable.governance_participation_type__required),
	OPTIONAL (R.string.governance_participation_type__optional, R.string.governance_participation_type__optional__description, R.drawable.governance_participation_type__optional);
	
	/**
	 * NONE - GUI will not display or provide means to input
	 * REQUIRED - GUI will display and require input
	 * OPTIONAL - GUI will display, but not require input (default to ???)
	 */
	
	public static final String name_COLUMN_1 = "governance_participation_type";
	public static final String name_COLUMN_2 = "description";
	
	public static GovernanceParticipationType getObjectForName(String aName) {
		for(GovernanceParticipationType theGovernanceParticipationType : GovernanceParticipationType.values()) {
			if(theGovernanceParticipationType.equals(aName)) {
				return theGovernanceParticipationType;
			}
		}
		return null;
	}

	private static FmmNodeDefinition fmmNodeDictionaryEntry = FmmNodeDefinition.getEntryForClass(GovernanceParticipationType.class);
	...
	GovernanceParticipationType(int aNameStringResourceId, int aDescriptionStringResourceId, int aDrawableResourceId) {
		...
		this.nodeId = new NodeId(
				FmmNodeDefinition.getEntryForClass(GovernanceParticipationType.class),
				getName() );
	}
