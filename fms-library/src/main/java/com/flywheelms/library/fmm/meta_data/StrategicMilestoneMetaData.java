/* @(#)StrategicMilestoneColumnDefinition.java
** 
...
public class StrategicMilestoneMetaData extends CompletableNodeMetaData {
	...
	public static final String child_fractals_STRATEGIC_ASSET = "StrategicAsset_list";
