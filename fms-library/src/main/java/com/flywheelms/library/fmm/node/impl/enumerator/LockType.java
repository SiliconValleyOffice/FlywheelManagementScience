...
public enum LockType implements FmmEnumNode {
	...
	NODE (R.string.lock_type__node, R.string.lock_type__node__description, R.drawable.lock_type__node, false, false),
	...
	TACTICAL_MILESTONES (R.string.lock_type__flywheel_milestones, R.string.lock_type__flywheel_milestones__description, R.drawable.fmm_noun__flywheel_milestone__gray, false, false),
