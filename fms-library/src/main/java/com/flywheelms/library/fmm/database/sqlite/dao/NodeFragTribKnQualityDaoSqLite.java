...
public class NodeFragTribKnQualityDaoSqLite extends NodeFragDaoSqLite<NodeFragTribKnQuality> {
	...
	protected void buildColumnIndexMap(Cursor aCursor) {
		...
		putColumnIndexMapEntry(this.columnIndexMap, aCursor, NodeFragTribKnQualityMetaData.column_TASK_POINT_BUDGET_QUALITY);
		putColumnIndexMapEntry(this.columnIndexMap, aCursor, NodeFragTribKnQualityMetaData.column_TASK_POINT_BUDGET_QUALITY_TIMESTAMP);
	...
	protected void getColumnValues(HashMap<String, Integer> aHashMap, Cursor aCursor, NodeFragTribKnQuality aNodeFragTribKnQuality) {
		...
		aNodeFragTribKnQuality.setTaskPointBudgetQuality(FmsDecoratorWorkTaskBudget.getObjectForName(aCursor.getString(aHashMap.get(NodeFragTribKnQualityMetaData.column_TASK_POINT_BUDGET_QUALITY))));
		aNodeFragTribKnQuality.setTaskPointBudgetQualityTimestamp(GcgDateHelper.getDateFromIso8601DateString(aCursor.getString(aHashMap.get(NodeFragTribKnQualityMetaData.column_TASK_POINT_BUDGET_QUALITY_TIMESTAMP))));
	...
	public ContentValues buildContentValues(NodeFragTribKnQuality aNodeFragTribKnQuality) {
		...
		theContentValues.put(NodeFragTribKnQualityMetaData.column_TASK_POINT_BUDGET_QUALITY, aNodeFragTribKnQuality.getTaskPointBudgetQuality().getName());
		GcgDateHelper.setIso8601DateContentValue(theContentValues, NodeFragTribKnQualityMetaData.column_TASK_POINT_BUDGET_QUALITY_TIMESTAMP, aNodeFragTribKnQuality.getTaskPointBudgetQualityTimestamp());
