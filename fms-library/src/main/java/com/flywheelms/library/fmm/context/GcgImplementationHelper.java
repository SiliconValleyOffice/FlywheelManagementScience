...
public class GcgImplementationHelper {
	...
	public static GcgFrame getFrameObjectForName(String aName) {
		return FmmFrame.getObjectForName(aName);
	}
	
	public static GcgPerspective getPerspectiveObjectForName(String aName) {
