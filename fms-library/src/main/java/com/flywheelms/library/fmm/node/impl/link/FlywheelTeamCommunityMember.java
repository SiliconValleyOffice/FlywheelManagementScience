/* @(#)FlywheelTeamLinkCommunityMember.java
** 
...
public class FlywheelTeamCommunityMember extends FmmLinkNodeImpl {

	public FlywheelTeamCommunityMember(
