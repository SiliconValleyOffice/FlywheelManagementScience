/* @(#)FseParagraphStyleOutdentButton.java
** 
...
public class FseParagraphStyleOutdentButton extends GcgMultiShiftClientButton {
...
//		FseParagraphStyleOutdentButton.supportedStateHashTable.put(GcgMultiShiftState.ALT_SHIFT, R.drawable.fse__style_outdent__green);
	...
	public FseParagraphStyleOutdentButton(
			Context aContext,
	...
	public HashMap<GcgMultiShiftState, Integer> getSupportedStateHashTable() {
		return FseParagraphStyleOutdentButton.supportedStateHashTable;
	}
