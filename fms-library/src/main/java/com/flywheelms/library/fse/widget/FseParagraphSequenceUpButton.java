...
public class FseParagraphSequenceUpButton extends GcgMultiShiftClientButton {
...
//		FseParagraphMoveUpButton.supportedStateHashTable.put(GcgMultiShiftState.ALT_SHIFT, R.drawable.fse__style_demote__green);
	...
	public FseParagraphSequenceUpButton(
			Context aContext,
	...
	public HashMap<GcgMultiShiftState, Integer> getSupportedStateHashTable() {
		return FseParagraphSequenceUpButton.supportedStateHashTable;
	}
