...
/*
 * TODO  will make this stronger to include things other than just text  -  SDS
 */
public class FseTemplateParagraph {
	
	private final FseParagraphStyle paragraphStyle;
	private final FseParagraphNumberingStyle numberingStyle;
	private final boolean locked;
	private final String text;

	public FseTemplateParagraph(
			FseParagraphStyle aParagraphStyle,
			FseParagraphNumberingStyle aNumberingStyle,
			boolean isLocked,
			String aTextString ) {
		this.paragraphStyle = aParagraphStyle;
		this.numberingStyle = aNumberingStyle;
		this.locked = isLocked;
		this.text = aTextString;
	}

	public FseParagraphStyle getParagraphStyle() {
