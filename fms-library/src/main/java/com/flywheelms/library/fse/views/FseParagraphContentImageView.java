/* @(#)FseParagraphContentImageView.java
** 
...
public class FseParagraphContentImageView  extends View implements FseParagraphContentView{
	
	FseParagraphView paragraphView;
	
	public FseParagraphContentImageView(FseParagraphView anFseParagraph) {
