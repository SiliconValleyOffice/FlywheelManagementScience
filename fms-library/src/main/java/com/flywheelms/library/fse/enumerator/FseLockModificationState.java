...
public enum FseLockModificationState implements ModificationState {
	...
	static {
		FseLockModificationState.nameTable.put(MODIFIED.getName(), MODIFIED);
		FseLockModificationState.nameTable.put(UNCHANGED.getName(), UNCHANGED);
	}
	public static FseLockModificationState getObjectForName(String aName) {
		return FseLockModificationState.nameTable.get(aName);
	}
	...
	private FseLockModificationState(String aName, int aSumamryDrawableResourceId, int aMarkupDrawableResourceId, int aPdfSumamryDrawableResourceId, int aPdfMarkupDrawableResourceId) {
		this.name = aName;
