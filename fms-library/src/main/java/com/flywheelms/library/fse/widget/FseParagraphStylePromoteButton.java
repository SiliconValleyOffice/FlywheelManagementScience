/* @(#)FseParagraphStylePromoteButton.java
** 
...
public class FseParagraphStylePromoteButton extends GcgMultiShiftClientButton {
...
//		FseParagraphStylePromoteButton.supportedStateHashTable.put(GcgMultiShiftState.ALT_SHIFT, R.drawable.fse__style_promote__green);
	...
	public FseParagraphStylePromoteButton(
			Context aContext,
	...
	public HashMap<GcgMultiShiftState, Integer> getSupportedStateHashTable() {
		return FseParagraphStylePromoteButton.supportedStateHashTable;
	}
