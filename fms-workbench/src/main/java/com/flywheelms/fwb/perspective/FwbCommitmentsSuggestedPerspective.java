/* @(#)FwbCommitmentsSuggestedPerspective.java
** 
...
public class FwbCommitmentsSuggestedPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.SUGGESTED_COMMITMENTS;
	}

	public FwbCommitmentsSuggestedPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.commitments__suggested;
	}

	@Override
	protected int getAbreviatedPageTitleResourceId() {
		return R.string.completion_commitment_type__suggested;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__SUGGESTED_COMMMITMENTS;
	}
