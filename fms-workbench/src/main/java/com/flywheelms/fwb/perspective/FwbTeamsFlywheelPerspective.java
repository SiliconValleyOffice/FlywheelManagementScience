/* @(#)FwbTeamsFlywheelPerspective.java
** 
...
public class FwbTeamsFlywheelPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.FLYWHEEL_TEAMS;
	}

	public FwbTeamsFlywheelPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.teams__flywheel;
	}

	@Override
	protected int getAbreviatedPageTitleResourceId() {
		return R.string.teams__flywheel__abreviated;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__TEAMS__FLYWHEEL;
	}
