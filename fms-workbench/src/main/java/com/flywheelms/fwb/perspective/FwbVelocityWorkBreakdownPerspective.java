/* @(#)FwbVelocityWorkBreakdownPerspective.java
** 
...
public class FwbVelocityWorkBreakdownPerspective extends FmsPerspectiveFlipperTreeView {
	...
	public FwbVelocityWorkBreakdownPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__VELOCITY__WORK_BREAKDOWN;
	}
