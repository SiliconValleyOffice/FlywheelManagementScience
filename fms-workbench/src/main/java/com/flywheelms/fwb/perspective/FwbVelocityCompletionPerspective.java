/* @(#)FwbVelocityCompletionPerspective.java
** 
...
public class FwbVelocityCompletionPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.COMPLETION;
	}

	public FwbVelocityCompletionPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.velocity__completion;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__VELOCITY__COMPLETION;
	}
