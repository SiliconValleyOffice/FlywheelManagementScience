/* @(#)FwbQualityWorkBreakdownPerspective.java
** 
...
public class FwbQualityWorkBreakdownPerspective extends FmsPerspectiveFlipperTreeView {
	...
	public FwbQualityWorkBreakdownPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.tribkn_quality__work_breakdown;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__QUALITY__WORK_BREAKDOWN;
	}
