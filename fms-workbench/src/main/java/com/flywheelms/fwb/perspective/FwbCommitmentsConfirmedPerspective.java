/* @(#)FwbCommitmentsConfirmedPerspective.java
** 
...
public class FwbCommitmentsConfirmedPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.CONFIRMED_COMMITMENTS;
	}

	public FwbCommitmentsConfirmedPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.commitments__confirmed;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__CONFIRMED_COMMITMENTS;
	}
