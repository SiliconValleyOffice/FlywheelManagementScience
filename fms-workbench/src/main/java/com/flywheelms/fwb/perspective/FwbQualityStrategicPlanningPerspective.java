/* @(#)FwbQualityStrategicPlanningPerspective.java
** 
...
public class FwbQualityStrategicPlanningPerspective extends FmsPerspectiveFlipperTreeView {
	...
	public FwbQualityStrategicPlanningPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__QUALITY__STRATEGIC_PLANNING;
	}
