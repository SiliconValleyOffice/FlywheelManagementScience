/* @(#)FwbTeamsFunctionalPerspective.java
** 
...
public class FwbTeamsFunctionalPerspective extends FmsPerspectiveFlipperTreeView {
	
	@Override
	public GcgPerspective getGcgPerspective() {
		return FmmPerspective.FUNCTIONAL_TEAMS;
	}

	public FwbTeamsFunctionalPerspective(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
	...
	protected int getPageTitleResourceId() {
		return R.string.teams__functional;
	}
	
	@Override
	protected int getAbreviatedPageTitleResourceId() {
		return R.string.teams__functional__abreviated;
	}
	...
	protected String getHelpContextUrlString() {
		return FmsHelpIndex.PERSPECTIVE__TEAMS__FUNCTIONAL;
	}
