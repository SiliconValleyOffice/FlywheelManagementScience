CREATE TABLE`NodeFragTribKnQuality` (
  ...
  `flywheel_commitment_quality` INT(11) NOT NULL ,
  `flywheel_commitment_quality_timestamp` BIGINT(14) NOT NULL ,
  `work_task_budget_quality` INT(11) NOT NULL ,
  `work_task_budget_quality_timestamp` BIGINT(14) NOT NULL ,
